...
<script src="//code.jquery.com/jquery-1.9.1.js"></script>
  ...
  function checkRegistrationForm(){
        ...
        $.ajax({
        type: "POST",
        url: "registerEmployee.htm",
        data: "password="+password+"&username="+username+"&firstName="+firstName+"&lastName="+lastName+"&phoneNumber="+phoneNumber+"&email="+email+"&address="+address+"&department="+department,
        success: function(response){
        // we have the response
        $('#registerEmployeeMessage').html(response);
        $('#password').val('');
        $('#username').val('');
        $('#firstName').val('');
        $('#lastName').val('');
  ...
  <div id="bd">
    <div id="yui-main">
      <div class="yui-b">
       ...
       <h1>Register Supplier Employees</h1>
       		<form>
            <table>
            ...
            <tr><td colspan="2"><td colspan="2"><div id="registerEmployeeMessage" ></div></td></tr>
            </table>
      		</form>
