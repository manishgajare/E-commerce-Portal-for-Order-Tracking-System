...
<script>
function shippingApproval(){
	  
	  $('#shippingApproval').submit();
...
<td>
<form method="POST" action="shippingApproval.htm" id="shippingApproval">
 <input type="hidden" id="orderItemId" name="orderItemId" value="${listOfOrderItemsElement.orderItemId}" />
 <input type="submit" value="Approve" onClick="shippingApproval()">
</form>
<br>

<form method="POST" action="shippingDone.htm" id="shippingDone">
<input type="text" id="confirmationCode" name="confirmationCode"  maxlength="8" size="8" /><br>
 <input type="hidden" id="orderItemId" name="orderItemId" value="${listOfOrderItemsElement.orderItemId}" />
 <input type="submit" value="Shipped" onClick="shippingDone()">
</form>
